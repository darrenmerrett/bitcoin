...
{
    const char* pszTimestamp = "The Sunday Express 14/Jan/2017 No deal will cost EU £500BN";
    const CScript genesisOutputScript = CScript() << ParseHex("04befebfedd28e8990e969c6575b0f4a6487fe3ab19c53a5398f4dd253dde5e29fc7e874e32a09ed8fe9dfc03e0f00eb9e8c1dbb7fd9abcef772a4009ce4bce613") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1515968333, 467627529, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000000068cf46c7008a34f17cbdad5af15e18d98e271d84ea849d77300bd088"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x02, 0x47, 0x45, 0x5F};
        base58Prefixes[EXT_SECRET_KEY] = {0x02, 0x32, 0x67, 0xAB};
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1516144737, 3761575270, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000eb0d3b549e776d3da0f27671fc4fe3cd9bb2f58f31382e218989bd6b"));
        assert(genesis.hashMerkleRoot == uint256S("0xffc2b34c6f9000b9db0e125064f193749c51303848d21deecdb9458b646e2e5c"));
